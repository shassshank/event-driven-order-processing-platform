        ...
        foreach (var message in messages)
        {
            ...
            try
            {
                ...
                _logger.LogInformation(
                    "Published outbox message {OutboxMessageId} with message id {MessageId} after {PublishAttempts} failed attempts.",
                    message.Id,
                    message.MessageId,
            ...
            catch (Exception ex) when (ex is not OperationCanceledException)
            {
                ...
                _logger.LogError(
                    ex,
                    "Failed to publish outbox message {OutboxMessageId} with message id {MessageId}. Attempt {PublishAttempts}/{MaxPublishAttempts}.",
                    message.Id,
                    message.MessageId,
                    message.PublishAttempts,
